...
# ======== x86_64 virtual side-router packages ========
# OpenClash（build25.sh 会按上游逻辑下载所需内核与 Geo 数据）
...
# ======== end x86_64 virtual side-router packages ========
